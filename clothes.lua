...
Config.Clothings.Drawables = {
	["Mask"] = {
		Drawable = 1,
		Table = { Standalone = true, Male = Config.Clothings.Standalone.Mask.Male, Female = Config.Clothings.Standalone.Mask.Female },
		Emote = { Dict = "mp_masks@standard_car@ds@", Anim = "put_on_mask", Move = 51, Dur = 800 }
	},
	["Neck"] = {
		Drawable = 7,
		Table = { Standalone = true, Male = Config.Clothings.Standalone.Neck.Male, Female = Config.Clothings.Standalone.Neck.Female },
	...
	["Top"] = {
		...
		Table = {
			Standalone = true,
			Male = Config.Clothings.Standalone.Jackets.Male,
			Female = Config.Clothings.Standalone.Jackets.Female,
			Extra = {
				{ Drawable = 3, Id = 5, Tex = 0, Name = "Extra Gloves" },
			}
		}, --Config.Clothings.Variations.Jackets,
		Emote = { Dict = "missmic4", Anim = "michael_tux_fidget", Move = 51, Dur = 1500 }
	},
	["Vest"] = {
		Drawable = 9,
		Table = { Standalone = true, Male = Config.Clothings.Standalone.Vest.Male, Female = Config.Clothings.Standalone.Vest.Female },
	...
	['Torso'] = {
		...
		Table = {
			Standalone = true,
			Male = Config.Clothings.Standalone.Shirt.Male,
			Female = Config.Clothings.Standalone.Shirt.Female,
			Extra = {
	...
	["Bag"] = {
		Drawable = 5,
		Table = { Standalone = true, Male = Config.Clothings.Standalone.Bagoff.Male, Female = Config.Clothings.Standalone.Bagoff.Female },
		Emote = { Dict = "anim@heists@ornate_bank@grab_cash", Anim = "intro", Move = 51, Dur = 1600 }
	},
	["Shoes"] = {
		Drawable = 6,
		Table = { Standalone = true, Male = Config.Clothings.Standalone.Shoes.Male, Female = Config.Clothings.Standalone.Shoes.Female },
		Emote = { Dict = "random@domestic", Anim = "pickup_low", Move = 0, Dur = 1200 }
	},
	["Pants"] = {
		Drawable = 4,
		Table = { Standalone = true, Male = Config.Clothings.Standalone.Pants.Male, Female = Config.Clothings.Standalone.Pants.Female },
		Emote = { Dict = "re@construction", Anim = "out_of_breath", Move = 51, Dur = 1300 }

	},
	["Gloves"] = {
		Drawable = 3,
		Table = Config.Clothings.Variations.Gloves,
		Remember = true,
		Emote = { Dict = "nmt_3_rcm-10", Anim = "cs_nigel_dual-10", Move = 51, Dur = 1200 }
	},
	["Hair"] = {
		Drawable = 2,
		Table = Config.Clothings.Variations.Hair,
		Remember = true,
...
Config.Clothings.Props = {
	...
	["Visor"] = {
		Prop = 0,
		Variants = Config.Clothings.Variations.Visor,
		Emote = {
			On = { Dict = "mp_masks@standard_car@ds@", Anim = "put_on_mask", Move = 51, Dur = 600 },
			Off = { Dict = "missheist_agency2ahelmet", Anim = "take_off_helmet_stand", Move = 51, Dur = 1200 }
		}
...
function AddNewVariation(which, gender, one, two, single)
	local Where = Config.Clothings.Variations[which][gender]
	if not single then
		Where[one] = two
		Where[two] = one
	else
...
Citizen.CreateThread(function()
	...
	for i = 1, 29 do
		if i == 15 then goto continue end
		AddNewVariation("Torso", 'Male', i, 0)
		::continue::
	end

	for i = 1, 29 do
		if i == 16 then goto continue end
		AddNewVariation("Torso", "Female", i, 0)
		::continue::
	end
end)
