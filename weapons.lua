----- IMPORTANT:
--- If you want to add new weapons, be sure to assign the type, ammo and name, always in lower case.
---- Please, follow the examples below in the item list.


OrgWeapons = {}
if Config.Framework == 'qbcore' then  
    local QBCore = exports['qb-core']:GetCoreObject()
    OrgWeapons = QBCore.Shared.Weapons
    if not OrgWeapons then
        print('^1ERROR: [origen_inventory]^3 Items not found in QBcore.Shared^0')
        return
    end
end
